...
Zdjęcia profilowe wymagają osobnego workera: `python manage.py db_worker --backend background --queue-name '*'`. Przy `DEBUG=True` są przetwarzane od razu w żądaniu.
