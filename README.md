...
Zdjęcia profilowe wymagają osobnego workera: `python manage.py db_worker --backend images --queue-name images --no-reload`. Przy `DEBUG=True` są przetwarzane od razu w żądaniu.
