...
class QuizMaxReoccurrencesTests(TestCase):
    ...
    def test_max_reoccurrences_positive_value(self):
        ...
        quiz = Quiz.objects.create(max_reoccurrences=5, maintainer=self.maintainer)
        self.assertEqual(quiz.max_reoccurrences, 5)

    def test_max_reoccurrences_zero_value(self):
        """Test: max_reoccurrences akceptuje zero"""
        quiz = Quiz.objects.create(max_reoccurrences=0, maintainer=self.maintainer)
    ...
    def test_max_reoccurrences_negative_value(self):
        ...
        quiz = Quiz(max_reoccurrences=-1, maintainer=self.maintainer)
    ...
    def test_max_reoccurrences_large_value(self):
        ...
        quiz = Quiz.objects.create(max_reoccurrences=999999, maintainer=self.maintainer)
    ...
    def test_max_reoccurrences_type_string_rejected(self):
        ...
        with self.assertRaises((ValueError, ValidationError, TypeError)):
            Quiz.objects.create(max_reoccurrences="text", maintainer=self.maintainer)
    ...
    def test_max_reoccurrences_none_value(self):
        ...
        if not field.null:
            with self.assertRaises(IntegrityError):
                Quiz.objects.create(max_reoccurrences=None, maintainer=self.maintainer)
    ...
    def test_max_reoccurrences_boundary_values(self):
        ...
        max_int = 2147483647
        quiz = Quiz.objects.create(max_reoccurrences=max_int, maintainer=self.maintainer)
    ...
    def test_max_reoccurrences_type_float_conversion(self):
        ...
        quiz = Quiz.objects.create(max_reoccurrences=5.7, maintainer=self.maintainer)
